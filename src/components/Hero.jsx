  ...
  return (
    ...
    custom-3xl:h-[95vh] custom-xl:h-[90vh] custom-tap:h-[85vh] h-[65vh]'>
      ...
      <div className='custom-container '>
        ...
        <div className=' custom-tap:pt-[120px] pt-[90px]'>
          <h1 className='text-white font-bold py-2
        ...
        <p className='text-white/60 custom-tap:text-xl text-base custom-tap:w-2/4 w-5/6 custom-tap:pt-10 pt-7'>{subtilte}</p>
